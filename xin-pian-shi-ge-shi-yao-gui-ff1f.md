...
大学里的电子类专业以及计算机专业，都会开一门关于电路设计的课程，当中基础的电子元件——晶体管，其本质就是——**『逻辑门』**。
...
『小或』呢，长期相亲失败，所以比『小与』的条件稍微宽松一些——性格好『**或**』长得帅。
...
再仔细想想，『非门』的条件（不能是Gay），其实『小与』和『小或』都需要啊，能不能给『小与』和『小或』前面也加个『非门』，恭喜你，发现了『电路设计』的精髓——把各个门联起来。这样，除了关于条件的判断 ，我们就能做出加法器、减法器、乘法器、除法器，以及控制器。

想象一下，有一堆条件需要判断，有一堆数字需要做计算。人能理解条件、计算式，而计算机需要把各个数字、条件存起来，然后靠控制器来操作谁和谁经过『与门』、谁和谁经过『或门』、谁和谁相加、谁和谁相减。。。

下图为7个『逻辑门』的图例，可以挑几个仔细看看：

* A、B为条件，0表示不满足，1表示满足
* 中间那个又圆又尖的一坨就是『逻辑门』
* Y就是结果，0表示能打开门，1表示打不开门 ![](/assets/gate_circuit.png)是不是有点晕？我们先来整理一下概念：
